...
from PyQt6.QtWidgets import QToolBar, QPushButton, QSpinBox, QLabel, QLineEdit, QComboBox, QVBoxLayout, QHBoxLayout, QWidget
...
class ControlToolBar(QToolBar):
    ...
    def __init__(self, state: AppState):
        ...
        self.select_montage.addItems(montage_controller.montage_types)
        self.select_montage.currentTextChanged.connect(self.on_montage_changed)

        self.open_file = QPushButton("Open")
        self.open_file.setIcon(QIcon(resource_path("./icons/folder.png", to_string=True)))
        self.open_file.clicked.connect(self.on_open_clicked)

        self.save_btn = QPushButton("Save Annotation")
        self.save_btn.setIcon(QIcon(resource_path("./icons/diskette.png", to_string=True)))
        self.save_btn.clicked.connect(self.on_save_clicked)
        self.save_btn.setEnabled(False)

        self.undo_btn = QPushButton("Undo")
        self.undo_btn.setIcon(QIcon(resource_path("./icons/undo.png", to_string=True)))
        self.undo_btn.setEnabled(False)
        self.undo_btn.clicked.connect(self.on_undo_clicked)
        # draw box btn
        self.label_btn = QPushButton("Label")
        self.label_btn.setIcon(QIcon(resource_path("./icons/add-selection.png", to_string=True)))
        ...
        self.low_filter.setPlaceholderText("Low filter")
        ...
        self.high_filter.setPlaceholderText("High filter")
    ...
    def on_montage_changed(self, new_montage):
